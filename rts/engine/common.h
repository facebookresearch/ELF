...
custom_enum(BulletState, INVALID_BULLETSTATE = -1, BULLET_CREATE = 0, BULLET_CREATE1, BULLET_CREATE2, BULLET_READY, BULLET_EXPLODE1, BULLET_EXPLODE2, BULLET_EXPLODE3, BULLET_DONE);
