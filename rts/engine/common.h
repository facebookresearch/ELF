...
custom_enum(UnitType, INVALID_UNITTYPE = -1,
    /* Minirts unit types*/
    RESOURCE = 0, WORKER, MELEE_ATTACKER, RANGE_ATTACKER, FLIGHT, BARRACKS, BASE, NUM_MINIRTS_UNITTYPE,
...
custom_enum(Terrain, INVALID_TERRAIN = -1, NORMAL = 0, IMPASSABLE = 1, WATER = 2, FOG = 3);
